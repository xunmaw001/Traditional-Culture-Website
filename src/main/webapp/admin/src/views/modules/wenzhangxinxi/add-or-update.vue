<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="文章类型" prop="wenzhangleixing">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="票数" prop="piaoshu">
          <el-input v-model="ruleForm.piaoshu" 
              placeholder="票数" clearable  :readonly="ro.piaoshu"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.wenzhangneirong = this.ruleForm.wenzhangneirong.replace(reg,'../../../ssmuizhd/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
