<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="文章类型" prop="wenzhangleixing">
          <el-input v-model="ruleForm.wenzhangleixing" 
              placeholder="文章类型" clearable  :readonly="ro.wenzhangleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="文章类型" prop="wenzhangleixing">
              <el-input v-model="ruleForm.wenzhangleixing" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="票数" prop="piaoshu">
          <el-select v-model="ruleForm.piaoshu" placeholder="请选择票数">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="投票日期" prop="toupiaoriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.toupiaoriqi" 
                type="date"
                placeholder="投票日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.toupiaoriqi" label="投票日期" prop="toupiaoriqi">
              <el-input v-model="ruleForm.toupiaoriqi" 
                placeholder="投票日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.toupiaoriqi = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.piaoshu = true;
          ...
          if(o=='toupiaoriqi'){
            this.ruleForm.toupiaoriqi = obj[o];
	    this.ro.toupiaoriqi = true;
            continue;
          }
        }
    ...
    onSubmit() {
      ...
      if(obj!=null) {
	      obj.piaoshu = parseFloat(obj.piaoshu) + parseFloat(this.ruleForm.piaoshu)
	      this.$http({
		  url: `${table}/update`,
		  method: "post",
		  data: obj
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `toupiaoxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.toupiaoxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
